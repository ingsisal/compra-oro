                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <div class="body">
							...
							<div id="botones">
							<button class="btn btn-primary waves-effect" type="button" onClick="enviarFormulario('guardar_m_usuario.php','frmgeneral','defaultModal');enviarFormulario2('cambio_boton_compra.php','frmgeneral','botonese')" data-toggle="modal" data-target="#defaultModal">Guardar Registro de Usuario</button>
