...
if($tip=="")
{
	echo '<p class="col-pink">Seleccionar tipo de Moneda</p>';
}
if($mon=="")
{
...
if($tip!="" && $mon!="")
{
	if($tip=="soles")
	{
		...
		$total=$monto+$mon;
		mysqli_query($link,"INSERT INTO `detalle_ingreso` (`tipo_det`,`ingreso_det`,`usuario_det`,`registro_det`) VALUES ('$tip','$mon','".$_SESSION['codigo']."','$registro');");
