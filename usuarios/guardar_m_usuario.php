...
if ($errorMSG == ""){
    ...
    if(consultasSQL::UpdateSQL("usuarios", "nombre_usu='$nombre',apellido_usu='$apellido',correo_usu='$correo',clave_usu='$pas',telefono_usu='$telefono',direccion_usu='$direccion',nivel_usu='$nivel'","id_usu='$cod'")){
