...
$cod=$_GET['codigo_p'];
$sql_pendiente=ejecutarSQL::consultar("select * from pendientes inner join detalle_pendientes on pendientes.codigo_com=detalle_pendientes.codigo_com where pendientes.codigo_com='$cod'");
...
<?php
$c=1;
$sql_datos=ejecutarSQL::consultar("select * from detalle_pendientes where codigo_com='$cod'");
...
?>
							...
							<button class="btn btn-primary waves-effect" type="button" onClick="enviarFormulario('guardar_compra_p.php?codigo=<?php echo $cod?>','frmgeneral','defaultModal');enviarFormulario2('cambio_botones_compra_p.php','frmgeneral','botones')" data-toggle="modal" data-target="#defaultModal">Guardar Compra</button>
