	...
	<div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                            <h2>
                                Registro de Gastos Adicionales
                                <small>Nuevo Registro</small>
                            </h2>
                        </div>
                        <div class="body">
                                <div class="col-lg-4 col-xs-12">
                                    <h2 class="card-inside-title">Registrado por</h2>
                                    <div class="form-group">
                                        <div class="form-line" id="bs_datepicker_container">
                                            <input class="form-control" type="text" value="<?php echo $_SESSION['nombre']." ".$_SESSION['apellido'];?>">
                                        </div>
                                    </div>
                                </div>
								<div class="col-lg-4 col-xs-12">
                                    <h2 class="card-inside-title">Tipo de Moneda</h2>
                                    <div class="form-group">
                                        <div class="form-line" id="bs_datepicker_container">
                                ...
                                <div class="col-lg-4 col-xs-12">
                                    <h2 class="card-inside-title">Agregar Monto de Gasto</h2>
                                    <div class="form-group">
                                        <div class="form-line" id="bs_datepicker_container">
								...
								<div class="col-lg-12 col-xs-12">
                                    <h2 class="card-inside-title">Detalle de Gasto</h2>
                                    <div class="form-group">
                                        <div class="form-line" id="bs_datepicker_container">
							...
							<div id="botonesss">
							<button class="btn btn-primary waves-effect" type="button" onClick="enviarFormulario('guardar_gasto.php','frmgeneral','defaultModal');enviarFormulario2('cambio_boton_compra.php','frmgeneral','botones')" data-toggle="modal" data-target="#defaultModal">Guardar Gastos Adicionales</button>
							</div>
                        </div>
                    </div>
                </div>
