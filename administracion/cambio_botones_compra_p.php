...
{
?>
<button class="btn btn-primary waves-effect" type="button" onClick="enviarFormulario('guardar_compra_p.php','frmgeneral','defaultModal');enviarFormulario2('cambio_botones_compra_p.php','frmgeneral','botones')" data-toggle="modal" data-target="#defaultModal">Guardar Compra</button>
<?php
}
if($ley!="" && $por!="" && $onz!="" && $can!="" && $cli!="" && $_POST['tipo-1']!="")
{
